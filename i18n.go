...
var languageMessages = map[string]messages{
	"ko": {
		...
		openRouterKeyDescription:  "OpenRouter API Key를 입력하세요. 연결 확인 후 Windows 자격 증명에 저장합니다.",
		openRouterSaved:           "OpenRouter 연결을 확인했고 API Key를 저장했습니다.",
		...
		errOpenRouterRateLimit:        "OpenRouter 요청 한도에 도달했습니다.\n\n잠시 후 다시 시도해주세요.",
	...
	"en": {
		...
		openRouterKeyLabel:        "API Key",
		openRouterKeyDescription:  "Enter your OpenRouter API Key. It will be validated and stored in Windows Credential Manager.",
		openRouterSaved:           "OpenRouter connection verified and API Key saved.",
		...
		errOpenRouterRateLimit:        "The OpenRouter request limit has been reached.\n\nTry again later.",
